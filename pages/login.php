<?php
// pages/login.php - Connexion Espace Étudiant
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($etudiant) {
            if (verifyPassword($password, $etudiant['mot_de_passe'])) {
            ...
            $error = "⚠️ Aucun compte trouvé avec cet email.";
        }
    }
}
?>
...
<head>
    ...
    <title>Connexion - Espace Étudiant | <?= SITE_NAME ?></title>
        ...
        <div class="login-body">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    ...
                    <input type="email" name="email" placeholder="etudiant@edu.uiz.ac.ma" required value="<?= htmlspecialchars($_POST['email'] ?? '') ?>">
